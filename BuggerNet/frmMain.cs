...
namespace BuggerNet
{
    public partial class frmMain : Form
    {
        ...
        private void unresponsiveUIToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void aVInNativeLibraryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmExPInvoke frmExPInvoke = new frmExPInvoke();
            frmExPInvoke.ShowDialog();
        }
    }
}
