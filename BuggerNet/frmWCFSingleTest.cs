...
namespace BuggerNet
{
    public partial class frmWCFSingleTest : Form
    {   
        public frmWCFSingleTest()
        {
            InitializeComponent();
            PrepareControls();
        }
        ...
        {
            BuggerNet.DemoServiceClient.DemoServiceClient dsc;
            ...
            {
                case "DemoServiceClient":
                    dsc = new BuggerNet.DemoServiceClient.DemoServiceClient();
                    //tbHostTime.Text = dsc.GetHostTime().ToLongTimeString();
                    pi = dsc.GetPerson();
                    dsc.Close();
